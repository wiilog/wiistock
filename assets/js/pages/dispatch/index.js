...
$(function() {
    initDispatchTable(false).then((returnedDispatchTable) => {
        ...
        if ($statutFilterOptionSelected.data('allowed-state')
            ...
            wrapLoadingOnActionButton($button, () => {
                return saveFilters('acheminement', '#tableDispatches', null, 1).then(() => {
                    ...
                    return initDispatchTable(true).then((returnedDispatchsTable) => {
    ...
    $groupedSignatureModeContainer.find(`.cancel`).on(`click`, function() {
        ...
        wrapLoadingOnActionButton($button, () => {
            tableDispatches.clear().destroy();
            return initDispatchTable(false).then((returnedArrivalsTable) => {
...
function initDispatchTable(groupedSignatureMode = false) {
    const $filtersContainer = $(".filters-container");
