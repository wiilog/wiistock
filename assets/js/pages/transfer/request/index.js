...
$(function() {
    ...
    InitModal(modalNewTransferRequest, SubmitNewTransferRequest, urlNewTransferRequest, {tables: [tableTransferRequest]});
...
function initTransferRequestTable() {
    ...
    tableTransferRequest = initDataTable('tableTransferRequest', transferRequestTableConfig);
}
