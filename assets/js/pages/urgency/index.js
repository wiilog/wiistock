...
global.callbackEditFormLoading = callbackEditFormLoading;
...
function initPage() {
    ...
    let tableUrgenceConfig = {
        ...
        columns:[
            ...
            { "data": 'arrivalDate', 'name' : 'arrivalDate', 'title' : Translation.of('Traçabilité', 'Urgences', 'Date arrivage UL', false) },
