...
global.checkIfRowSelected = checkIfRowSelected;
global.printArticles = printArticles;
global.openLocationModal = openLocationModal;
global.finishCollecte = finishCollecte;
...
function initArticleTable() {
    ...
    tableArticle = initDataTable('tableArticle', tableArticleConfig);
}
