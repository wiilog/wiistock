...
function initCollecteTable() {
    ...
    let collecteTable = initDataTable('tableCollecte_id', collecteTableConfig);
}
...
$(function() {
    ...
    InitModal(modalNewCollecte, SubmitNewCollecte, urlNewCollecte, {tables: [collecteTable]});
    ...
    InitModal(modalDeleteCollecte, submitDeleteCollecte, urlDeleteCollecte, {tables: [collecteTable]});
...
$.fn.dataTable.ext.search.push(
    function (settings, data, dataIndex) {
        ...
        let indexDate = collecteTable.column('Création:name').index();
