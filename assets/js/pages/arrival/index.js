...
global.onFlyFormOpened = onFlyFormOpened;
...
$(function () {
    ...
    initArrivalTable(false).then((returnedArrivalsTable) => {
    ...
    $(`.dispatch-mode-button`).on(`click`, function () {
        ...
        initArrivalTable(true).then((returnedArrivalsTable) => {
            arrivalsTable = returnedArrivalsTable;
...
function initArrivalTable(dispatchMode = false) {
