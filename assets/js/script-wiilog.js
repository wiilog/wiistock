...
global.clickNotification = clickNotification;
global.openQueryModal = openQueryModal;
global.deleteRow = deleteRow;
global.showRow = showRow;
global.editRow = editRow;
global.typeChoice = typeChoice;
global.toggleRequiredChampsLibres = toggleRequiredChampsLibres;
global.clearErrorMsg = clearErrorMsg;
global.clearModal = clearModal;
global.saveFilters = saveFilters;
global.initDatePickers = initDatePickers;
global.checkAndDeleteRow = checkAndDeleteRow;
global.redirectToDemandeLivraison = redirectToDemandeLivraison;
global.onFlyFormToggle = onFlyFormToggle;
global.onFlyFormSubmit = onFlyFormSubmit;
global.initDateTimePicker = initDateTimePicker;
global.saveExportFile = saveExportFile;
global.limitTextareaLength = limitTextareaLength;
global.onTypeChange = onTypeChange;
global.loadAndDisplayLabels = loadAndDisplayLabels;
global.loadAndDisplayInfos = loadAndDisplayInfos;
global.openModal = openModal;
global.initOnTheFlyCopies = initOnTheFlyCopies;
global.hideSpinner = hideSpinner;
global.displayFiltersSup = displayFiltersSup;
global.GetRequestQuery = GetRequestQuery;
global.updateQuantityDisplay = updateQuantityDisplay;
global.clearInvalidInputs = clearInvalidInputs;
global.loadSpinner = loadSpinner;
global.displayRight = displayRight;
global.displayWrong = displayWrong;
global.displayNeutral = displayNeutral;
global.fillDatePickers = fillDatePickers;
global.displayAlertModal = displayAlertModal;
global.managePrintButtonTooltip = managePrintButtonTooltip;
global.fillDemandeurField = fillDemandeurField;
global.SetRequestQuery = SetRequestQuery;
global.getBSAlertModal = getBSAlertModal;
global.scrollToBottom = scrollToBottom;
global.registerCopyToClipboard = registerCopyToClipboard;

global.PAGE_PURCHASE_REQUEST = PAGE_PURCHASE_REQUEST;
global.PAGE_TRANSFER_REQUEST = PAGE_TRANSFER_REQUEST;
global.PAGE_TRANSFER_ORDER = PAGE_TRANSFER_ORDER;
global.PAGE_DEM_COLLECTE = PAGE_DEM_COLLECTE;
global.PAGE_DEM_LIVRAISON = PAGE_DEM_LIVRAISON;
global.PAGE_HAND = PAGE_HAND;
global.PAGE_ORDRE_COLLECTE = PAGE_ORDRE_COLLECTE;
global.PAGE_ORDRE_LIVRAISON = PAGE_ORDRE_LIVRAISON;
global.PAGE_PREPA = PAGE_PREPA;
global.PAGE_LU_ARRIVAL = PAGE_LU_ARRIVAL;
global.PAGE_IMPORT = PAGE_IMPORT;
global.PAGE_EXPORT = PAGE_EXPORT;
global.PAGE_ALERTE = PAGE_ALERTE;
global.PAGE_RECEPTION = PAGE_RECEPTION;
global.PAGE_MVT_STOCK = PAGE_MVT_STOCK;
global.PAGE_MVT_TRACA = PAGE_MVT_TRACA;
global.PAGE_PACK = PAGE_PACK;
global.PAGE_LITIGE_ARR = PAGE_LITIGE_ARR;
global.PAGE_ENCOURS = PAGE_ENCOURS;
global.PAGE_INV_ENTRIES = PAGE_INV_ENTRIES;
global.PAGE_INV_MISSIONS = PAGE_INV_MISSIONS;
global.PAGE_INV_SHOW_MISSION = PAGE_INV_SHOW_MISSION;
global.PAGE_RECEIPT_ASSOCIATION = PAGE_RECEIPT_ASSOCIATION;
global.PAGE_DISPATCHES = PAGE_DISPATCHES;
global.PAGE_STATUS = PAGE_STATUS;
global.PAGE_EMPLACEMENT = PAGE_EMPLACEMENT;
global.PAGE_TRANSPORT_REQUESTS = PAGE_TRANSPORT_REQUESTS;
global.PAGE_PREPARATION_PLANNING = PAGE_PREPARATION_PLANNING;
global.PAGE_TRANSPORT_ORDERS = PAGE_TRANSPORT_ORDERS;
global.PAGE_SUBCONTRACT_ORDERS = PAGE_SUBCONTRACT_ORDERS;
global.PAGE_TRANSPORT_ROUNDS = PAGE_TRANSPORT_ROUNDS;
global.PAGE_URGENCES = PAGE_URGENCES;
global.PAGE_NOTIFICATIONS = PAGE_NOTIFICATIONS;
global.PAGE_TRUCK_ARRIVAL = PAGE_TRUCK_ARRIVAL;
global.PAGE_SHIPPING = PAGE_SHIPPING;
global.STATUT_ACTIF = STATUT_ACTIF;
global.STATUT_INACTIF = STATUT_INACTIF;
global.STATUT_EN_TRANSIT = STATUT_EN_TRANSIT;
global.SELECT2_TRIGGER_CHANGE = SELECT2_TRIGGER_CHANGE;
global.DATE_FORMATS_TO_DISPLAY = DATE_FORMATS_TO_DISPLAY;
