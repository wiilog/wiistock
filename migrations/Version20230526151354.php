...
final class Version20230526151354 extends AbstractMigration
{
    ...
    {
        // rename into FieldsParam::FIELD_CODE_EMERGENCY_TYPE the filed param where entity_code = FieldsParam::ENTITY_CODE_EMERGENCY and field code = "type"
        $this->addSql('UPDATE fields_param SET field_code = :newCode WHERE entity_code = :entityCode AND field_code = :oldCode', [
            ...
            'entityCode' => FieldsParam::ENTITY_CODE_EMERGENCY,
            'oldCode' => 'type'
        ]);
    }
