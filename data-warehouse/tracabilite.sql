SELECT tracking_movement.id              AS mouvement_traca_id,
       ...
       tracking_movement_pack_group.code AS groupe,
...
FROM tracking_movement
         ...
         LEFT JOIN `group` AS tracking_movement_pack_group
                   ON tracking_movement_pack.pack_group_id = tracking_movement_pack_group.id
