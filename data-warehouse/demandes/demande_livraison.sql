...
FROM (SELECT demande.id                                                                                            AS id,
      ...
      FROM demande
               ...
               LEFT JOIN emplacement AS destination ON demande.destination_id = destination.id
               LEFT JOIN type ON demande.type_id = type.id
               INNER JOIN delivery_request_reference_line ON demande.id = delivery_request_reference_line.request_id
               ...
               LEFT JOIN project AS request_reference_line_project ON delivery_request_reference_line.project_id = request_reference_line_project.id
