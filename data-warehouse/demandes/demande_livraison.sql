...
FROM (
         SELECT demande.id                                      AS id,
                ...
                preparation_order_article_line.quantity_to_pick AS quantite_a_prelever
         ...
         FROM demande
                  ...
                  INNER JOIN preparation_order_article_line
                             ON preparation.id = preparation_order_article_line.preparation_id
                  INNER JOIN article ON preparation_order_article_line.article_id = article.id
         ...
         SELECT demande.id                                        AS id,
                ...
                preparation_order_reference_line.quantity_to_pick AS quantite_a_prelever
         ...
         FROM demande
                  ...
                  LEFT JOIN type ON demande.type_id = type.id
                  INNER JOIN preparation ON demande.id = preparation.demande_id
                  INNER JOIN preparation_order_reference_line
