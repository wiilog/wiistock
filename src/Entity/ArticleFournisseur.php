...
class ArticleFournisseur {
    ...
    #[ORM\ManyToOne(targetEntity: ReferenceArticle::class, inversedBy: 'articlesFournisseur')]
    ...
    #[ORM\ManyToOne(targetEntity: Fournisseur::class, inversedBy: 'articlesFournisseur', cascade: ['PERSIST'])]
    ...
    #[ORM\OneToMany(targetEntity: Article::class, mappedBy: 'articleFournisseur')]
    private Collection $articles;

    #[ORM\OneToMany(targetEntity: ReceptionReferenceArticle::class, mappedBy: 'articleFournisseur')]
