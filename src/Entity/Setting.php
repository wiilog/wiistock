...
class Setting {
    ...
    const GENERAL_TOP_LEFT_LOGO = 'GENERAL_TOP_LEFT_LOGO';
    const GENERAL_TOP_RIGHT_LOGO = 'GENERAL_TOP_RIGHT_LOGO';
    const GENERAL_INFORMATION_MESSAGE = 'GENERAL_INFORMATION_MESSAGE';
