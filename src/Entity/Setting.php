...
class Setting {
    ...
    const SHIPPING_FOURNISSEUR_LABEL_REFERENCE_CREATE = 'SHIPPING_FOURNISSEUR_LABEL_REFERENCE_CREATE';
    const SHIPPING_FOURNISSEUR_REFERENCE_CREATE = 'SHIPPING_FOURNISSEUR_REFERENCE_CREATE';
    const SHIPPING_REF_ARTICLE_FOURNISSEUR_EQUALS_REFERENCE = 'SHIPPING_REF_ARTICLE_FOURNISSEUR_EQUALS_REFERENCE';
    const SHIPPING_ARTICLE_FOURNISSEUR_LABEL_EQUALS_REFERENCE_LABEL = 'SHIPPING_ARTICLE_FOURNISSEUR_LABEL_EQUALS_REFERENCE_LABEL';
