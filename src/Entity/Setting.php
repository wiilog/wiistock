...
class Setting {
    ...
    const USE_AI_ARRIVALS = 'USE_AI_ARRIVALS';
    const DISPLAY_SCANNED_DELIVERY_NOTE = 'DISPLAY_SCANNED_DELIVERY_NOTE';
    const DN_READER_URL = 'DN_READER_URL';
    const DN_READER_SECRET_KEY = 'DN_READER_SECRET_KEY';
    ...
    // stock - forecast
    const STOCK_FORECAST_URL = 'STOCK_FORECAST_URL';
    const STOCK_FORECAST_SECRET_KEY = 'STOCK_FORECAST_SECRET_KEY';
