...
class Setting {
    ...
    const DEFAULT_WEBSITE_LOGO_VALUE = '/img/website_logo.png';
    const DEFAULT_EMAIL_LOGO_VALUE = '/img/default_logo.png';
    const DEFAULT_MOBILE_LOGO_LOGIN_VALUE = '/img/mobile_logo_login.png';
    const DEFAULT_MOBILE_LOGO_HEADER_VALUE = '/img/mobile_logo_header.png';
    const DEFAULT_TOP_LEFT_VALUE = '/img/default_logo.png';
    ...
    const PACK_SEPARATION_AUTO_DROP_PACK_PARENT_ON_LOCATION = 'PACK_SEPARATION_AUTO_DROP_PACK_PARENT_ON_LOCATION';
    const PACK_SEPARATION_AUTO_DROP_LOCATION = 'PACK_SEPARATION_AUTO_DROP_LOCATION';
    ...
    const DISPATCH_OVERCONSUMPTION_CHANGE_TYPE = 'DISPATCH_OVERCONSUMPTION_CHANGE_TYPE';
    const DISPATCH_OVERCONSUMPTION_CHANGE_STATUS = 'DISPATCH_OVERCONSUMPTION_CHANGE_STATUS';
