...
class Setting {
    ...
    const DROP_OFF_LOCATION_IF_RECIPIENT = 'DROP_OFF_LOCATION_IF_RECIPIENT';
    const ARRIVAL_EMERGENCY_TRIGGERING_FIELDS = 'ARRIVAL_EMERGENCY_TRIGGERING_FIELDS';
    const CONFIRM_EMERGENCY_ON_ARRIVAL = 'CONFIRM_EMERGENCY_ON_ARRIVAL';
    const USE_TRUCK_ARRIVALS = 'USE_TRUCK_ARRIVALS';
    const ARRIVAL_NUMBER_FORMAT = 'ARRIVAL_NUMBER_FORMAT';
    const RFID_ON_MOBILE_TRACKING_MOVEMENTS = 'RFID_ON_MOBILE_TRACKING_MOVEMENTS';
    const DROP_MOVEMENT_ON_GROUPING = 'DROP_MOVEMENT_ON_GROUPING';
    const GROUP_GET_CHILD_TRACKING_DELAY = 'GROUP_GET_CHILD_TRACKING_DELAY';

    const TREATMENT_DELAY_IN_PROGRESS = 'in_progress';
    const TREATMENT_DELAY_ON_HOLD = 'on_hold';
    const TREATMENT_DELAY_BOTH = 'both';
    ...
    const AUTO_PRINT_TRUCK_ARRIVAL_LABEL = "AUTO_PRINT_TRUCK_ARRIVAL_LABEL";
    ...
    // mvt traca
    const CLEAR_AND_KEEP_MODAL_AFTER_NEW_MVT = 'CLEAR_AND_KEEP_MODAL_AFTER_NEW_MVT';
    const DISPLAY_WARNING_WRONG_LOCATION = 'DISPLAY_WARNING_WRONG_LOCATION';
    const SEND_PACK_DELIVERY_REMIND = 'SEND_PACK_DELIVERY_REMIND';
    const DISPLAY_MANUAL_DELAY_START = 'DISPLAY_MANUAL_DELAY_START';
    ...
    const ARTICLE_LOCATION_DROP_WITH_REFERENCE_STORAGE_RULES = 'ARTICLE_LOCATION_DROP_WITH_REFERENCE_STORAGE_RULE';
    ...
    const DELIVERY_STATION_TOP_RIGHT_LOGO = 'DELIVERY_STATION_TOP_RIGHT_LOGO';
    const DELIVERY_STATION_INFORMATION_MESSAGE = 'DELIVERY_STATION_INFORMATION_MESSAGE';
    ...
    const DISPATCH_NUMBER_FORMAT = 'DISPATCH_NUMBER_FORMAT';
    const DISPATCH_FIXED_FIEDS_ON_FILTERS = 'DISPATCH_FIXED_FIEDS_ON_FILTERS';
    ...
    const USER_MESSAGE_CONFIG = 'USER_MESSAGE_CONFIG';
    ...
    const AUTOMATICALLY_CREATE_MOVEMENT_ON_VALIDATION = 'AUTOMATICALLY_CREATE_MOVEMENT_ON_VALIDATION';
    const AUTOMATICALLY_CREATE_MOVEMENT_ON_VALIDATION_TYPES = 'AUTOMATICALLY_CREATE_MOVEMENT_ON_VALIDATION_TYPES';
    const AUTO_UNGROUP = 'AUTO_UNGROUP';
    const AUTO_UNGROUP_TYPES = 'AUTO_UNGROUP_TYPES';
    ...
    const INCLUDE_SHOW_DATE_AND_HOUR_ARRIVAL_UL = "INCLUDE_SHOW_DATE_AND_HOUR_ARRIVAL_UL";
    const INCLUDE_TYPE_LOGO_ON_TAG = "INCLUDE_TYPE_LOGO_ON_TAG";
    const INCLUDE_TRUCK_ARRIVAL_DATE_AND_HOUR = "INCLUDE_TRUCK_ARRIVAL_DATE_AND_HOUR";
    const INCLUDE_TRUCK_ARRIVAL_DATE_AND_HOUR_BARCODE = "INCLUDE_TRUCK_ARRIVAL_DATE_AND_HOUR_BARCODE";
    const INCLUDE_PACK_NATURE = "INCLUDE_PACK_NATURE";
    const INCLUDE_LIMIT_TREATMENT_DATE  = "INCLUDE_LIMIT_TREATMENT_DATE";
    ...
    // mailer
    const MAILER_SENDER_NAME = 'MAILER_SENDER_NAME';

    // production
    const PRODUCTION_NEW_REFERENCE_TYPE = 'PRODUCTION_NEW_REFERENCE_TYPE';
    const SENDING_EMAIL_EVERY_STATUS_CHANGE_IF_EMERGENCY = "SENDING_EMAIL_EVERY_STATUS_CHANGE_IF_EMERGENCY";
    const SENDING_EMAIL_EVERY_STATUS_CHANGE_IF_EMERGENCY_USERS = "SENDING_EMAIL_EVERY_STATUS_CHANGE_IF_EMERGENCY_USERS";
    const COPYING_REQUESTER_NOTIFICATION_EMAIL_IF_EMERGENCY  = "COPYING_REQUESTER_NOTIFICATION_EMAIL_IF_EMERGENCY";
    const PRODUCTION_FIXED_FIELDS_ON_FILTERS = 'PRODUCTION_FIXED_FIElDS_ON_FILTERS';
    ...
    // acheminements
    const KEEP_MODAL_OPEN_AND_CLEAR_AFTER_SUBMIT = "KEEP_MODAL_OPEN_AND_CLEAR_AFTER_SUBMIT";
    const KEEP_MODAL_OPEN_AND_CLEAR_AFTER_SUBMIT_FOR_ROLES = "KEEP_MODAL_OPEN_AND_CLEAR_AFTER_SUBMIT_FOR_ROLES";
