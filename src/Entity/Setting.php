...
class Setting {
    ...
    const TRANSPORT_ROUND_START_POINT_KM = 'TRANSPORT_ROUND_START_POINT_KM';
    const TRANSPORT_ROUND_START_POINT_HOURLY_CALCUL = 'TRANSPORT_ROUND_START_POINT_HOURLY_CALCUL';
    const TRANSPORT_ROUND_DELIVERY_END_POINT = 'TRANSPORT_ROUND_DELIVERY_END_POINT';
