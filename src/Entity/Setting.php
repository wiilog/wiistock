...
class Setting {
    ...
    // mvt traca
    const CLEAR_AND_STAY_AFTER_NEW_MVT = 'CLEAR_AND_STAY_AFTER_NEW_MVT';
    ...
    const DELIVERIES_EXPECTED_DATE_COLOR_AFTER = 'DELIVERIES_EXPECTED_DATE_COLOR_AFTER';
    const DELIVERIES_EXPECTED_DATE_COLOR_D_DAY = 'DELIVERIES_EXPECTED_DATE_COLOR_D_DAY';
    const DELIVERIES_EXPECTED_DATE_COLOR_BEFORE = 'DELIVERIES_EXPECTED_DATE_COLOR_BEFORE';
