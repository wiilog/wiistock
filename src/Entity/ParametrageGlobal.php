...
class ParametrageGlobal
{
    ...
    // stock
    const SEND_MAIL_MANAGER_ALERT_THRESHOLD = 'ENVOI MAIL GESTIONNAIRE SEUIL ALERTE ATTEINT';
    const SEND_MAIL_MANAGER_SECURITY_THRESHOLD = 'ENVOI MAIL GESTIONNAIRE SEUIL SECURITE ATTEINT';
