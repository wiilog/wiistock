...
class ParametrageGlobal
{
    ...
    const DASHBOARD_PACKAGING_11 = 'DASHBOARD_PACKAGING_11';
    const DASHBOARD_PACKAGING_12 = 'DASHBOARD_PACKAGING_12';
    const DASHBOARD_PACKAGING_13 = 'DASHBOARD_PACKAGING_13';
    const DASHBOARD_PACKAGING_14 = 'DASHBOARD_PACKAGING_14';
