...
class PreparationOrderArticleLine {
    ...
    #[ORM\ManyToOne(targetEntity: DeliveryRequestArticleLine::class)]
    #[ORM\JoinColumn(nullable: true)]
    private ?DeliveryRequestArticleLine $deliveryRequestArticleLine = null;
    ...
    public function clone(): PreparationOrderArticleLine {
        return (new PreparationOrderArticleLine())
            ...
            ->setDeliveryRequestReferenceLine($this->getDeliveryRequestReferenceLine())
            ->setDeliveryRequestArticleLine($this->getDeliveryRequestArticleLine());
    }
    ...
    public function getDeliveryRequestArticleLine(): ?DeliveryRequestArticleLine {
        return $this->deliveryRequestArticleLine;
    }

    public function setDeliveryRequestArticleLine(?DeliveryRequestArticleLine $deliveryRequestArticleLine): self {
        $this->deliveryRequestArticleLine = $deliveryRequestArticleLine;
        return $this;
    }
}
