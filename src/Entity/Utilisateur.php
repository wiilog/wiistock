...
class Utilisateur implements UserInterface, EquatableInterface, PasswordAuthenticatedUserInterface {
    ...
    const DEFAULT_SHIPPING_REQUEST_VISIBLE_COLUMNS = ["trackingNumber", "status", "createdAt", "requestCaredAt", "validatedAt", "plannedAt", "expectedPickedAt", "treatedAt", "requesters", "customerOrderNumber", "customerName", "carrier"];
