 ...
 */
final class Version20200729083440 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this
            ->addSql('ALTER TABLE arrivage ADD free_fields JSON DEFAULT NULL;');


        $entityCategoryTypeLabel = CategoryType::ARRIVAGE;
            ...
            $entityFreeFieldValuesInDB = $this
                ...
                ->executeQuery("
                        SELECT
                            ...
                            t.id as typeId
                        FROM arrivage
                        LEFT JOIN arrivage_valeur_champ_libre vcla on arrivage.id = vcla.arrivage_id
