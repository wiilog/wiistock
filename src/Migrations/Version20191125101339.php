...
final class Version20191125101339 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mouvement_traca ADD FOREIGN KEY `mouvement_traca_utilisateur_fk1` (operateur) REFERENCES utilisateur(id)');
		...
		$this->addSql('ALTER TABLE mouvement_traca ADD FOREIGN KEY `mouvement_traca_emplacement_fk1` (ref_emplacement) REFERENCES emplacement(id)');
