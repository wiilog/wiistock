...
final class Version20200313090612 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("UPDATE reference_article AS ra SET quantite_stock = 0 WHERE quantite_stock IS NULL");
        $this->addSql("
                            UPDATE reference_article AS ra
        ...
        $this->addSql("UPDATE reference_article AS ra SET quantite_reservee = 0 WHERE quantite_reservee IS NULL");
        $this->addSql("
                            UPDATE reference_article AS ra
