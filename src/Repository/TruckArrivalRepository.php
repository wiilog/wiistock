...
class TruckArrivalRepository extends EntityRepository
{
    ...
    public function iterateByDates(DateTime $dateMin, DateTime $dateMax): iterable {
        $queryBuilder = $this->createQueryBuilder('truck_arrival')
            ...
            ->addSelect("GROUP_CONCAT(join_trackingLines_reserve_type.label SEPARATOR ',') AS carrierTrackingNumberReserve")
            ->addSelect("GROUP_CONCAT(join_trackingLines.number SEPARATOR ',') AS carrierTrackingNumber")
