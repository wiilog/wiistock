 ...
 */
class AlertTemplateRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, AlertTemplate::class);
    }

    // /**
    //  * @return AlertTemplate[] Returns an array of AlertTemplate objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?AlertTemplate
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.exampleField = :val')
            ->setParameter('val', $value)
