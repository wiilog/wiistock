    ...
    public function getColumnVisibleConfig(Utilisateur $currentUser): array {
        ...
        return $this->fieldModesService->getArrayConfig(
            [
                ...
                ["name" => 'buyers', 'title' => $this->translation->translate('Traçabilité', 'Arrivages UL', 'Champs fixes', 'Acheteur(s)'), "orderable" => false],
                ...
                ["name" => 'references', 'title' => 'Référence', "orderable" => false],
                ["name" => 'lastHistoryRecord', 'title' => $this->translation->translate('Qualité', 'Litiges', 'Dernier historique'), "orderable" => false],
