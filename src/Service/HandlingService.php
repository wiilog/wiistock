    ...
    public function sendEmailsAccordingToStatus(EntityManagerInterface $entityManager,
        ...
        if (!empty($emailReceivers)) {
            ...
            if ($isNewHandlingAndNotTreated) {
                $subject = ['Demande', 'Services', 'Emails', 'Follow Nexter // Création d\'une demande de service', false];
                $title = ['Demande', 'Services', 'Emails', 'Votre demande de service a été créée', false];
            } else {
                $subject = $statusTreated
                    ? ['Demande', 'Services', 'Emails', 'Follow Nexter // Demande de service effectuée', false]
                    : ['Demande', 'Services', 'Email', 'Follow Nexter // Changement de statut d\'une demande de service', false];
                $title = $statusTreated
