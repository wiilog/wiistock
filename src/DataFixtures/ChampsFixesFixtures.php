    ...
    public function load(ObjectManager $manager) {
        ...
        $listEntityFieldCodes = [
            FieldsParam::ENTITY_CODE_RECEPTION => [
                ...
                ['code' => FieldsParam::FIELD_CODE_EMPLACEMENT, 'label' => FieldsParam::FIELD_LABEL_EMPLACEMENT, 'displayedCreate' => true, 'displayedEdit' => true, 'displayedFilters' => true, 'default' => true],
            ...
            FieldsParam::ENTITY_CODE_DISPATCH => [
                ...
                ['code' => FieldsParam::FIELD_CODE_CUSTOMER_NAME_DISPATCH, 'label' => FieldsParam::FIELD_LABEL_CUSTOMER_NAME . '<img src="/svg/information.svg" width="12px" height="12px" class="has-tooltip ml-1" title="Donnée provenant du référentiel client">', 'displayedCreate' => false, 'displayedEdit' => false, 'displayedFilters' => false, 'default' => false],
                ['code' => FieldsParam::FIELD_CODE_CUSTOMER_PHONE_DISPATCH, 'label' => FieldsParam::FIELD_LABEL_CUSTOMER_PHONE . '<img src="/svg/information.svg" width="12px" height="12px" class="has-tooltip ml-1" title="Donnée provenant du référentiel client">', 'displayedCreate' => false, 'displayedEdit' => false, 'displayedFilters' => false, 'default' => false],
                ['code' => FieldsParam::FIELD_CODE_CUSTOMER_RECIPIENT_DISPATCH, 'label' => FieldsParam::FIELD_LABEL_CUSTOMER_RECIPIENT_DISPATCH . '<img src="/svg/information.svg" width="12px" height="12px" class="has-tooltip ml-1" title="Donnée provenant du référentiel client">', 'displayedCreate' => false, 'displayedEdit' => false, 'displayedFilters' => false, 'default' => false],
                ['code' => FieldsParam::FIELD_CODE_CUSTOMER_ADDRESS_DISPATCH, 'label' => FieldsParam::FIELD_LABEL_CUSTOMER_ADDRESS . '<img src="/svg/information.svg" width="12px" height="12px" class="has-tooltip ml-1" title="Donnée provenant du référentiel client">', 'displayedCreate' => false, 'displayedEdit' => false, 'displayedFilters' => false, 'default' => false],
            ],
            ...
            FieldsParam::ENTITY_CODE_ARTICLE => [
                ...
                ['code' => FieldsParam::FIELD_CODE_ARTICLE_MANUFACTURED_AT, 'label' => FieldsParam::FIELD_LABEL_ARTICLE_MANUFACTURED_AT, 'displayedCreate' => false, 'displayedEdit' => false, 'displayedFilters' => false],
