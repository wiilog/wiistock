    ...
    public function load(ObjectManager $manager) {
        ...
        $listEntityFieldCodes = [
            ...
            FieldsParam::ENTITY_CODE_DEMANDE => [
                ['code' => FieldsParam::FIELD_CODE_EXPECTED_AT, 'label' => FieldsParam::FIELD_CODE_EXPECTED_AT, 'displayedCreate' => true, 'displayedEdit' => true, 'displayedFilters' => true],
            ],
            ...
            FieldsParam::ENTITY_CODE_DISPATCH => [
                ...
                ['code' => FieldsParam::FIELD_CODE_BUSINESS_UNIT, 'label' => FieldsParam::FIELD_LABEL_BUSINESS_UNIT, 'values' => [], 'displayedCreate' => true, 'displayedEdit' => true, 'displayedFilters' => true],
