    ...
    public function load(ObjectManager $manager) {
        ...
        $listEntityFieldCodes = [
            ...
            FieldsParam::ENTITY_CODE_ARRIVAGE => [
                ...
                ['code' => FieldsParam::FIELD_CODE_RECEIVERS, 'label' => FieldsParam::FIELD_LABEL_RECEIVERS, 'displayedCreate' => true, 'displayedEdit' => true, 'displayedFilters' => true, 'default' => true],
