    ...
    public function load(ObjectManager $manager) {
        ...
        $listEntityFieldCodes = [
            ...
            FixedFieldStandard::ENTITY_CODE_ARRIVAGE => [
                ...
                ['code' => FixedFieldStandard::FIELD_CODE_BUSINESS_UNIT, 'label' => FixedFieldStandard::FIELD_LABEL_BUSINESS_UNIT, 'values' => [], 'displayedCreate' => true, 'displayedEdit' => true, 'displayedFilters' => true, 'default' => false, 'elementsType' => FieldsParam::ELEMENTS_TYPE_FREE],
