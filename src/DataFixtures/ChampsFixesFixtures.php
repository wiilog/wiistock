    ...
    public function load(ObjectManager $manager) {
        ...
        $listEntityFieldCodes = [
            ...
            FieldsParam::ENTITY_CODE_DEMANDE => [
                ...
                ['code' => FieldsParam::FIELD_CODE_DEMANDE_PROJECT, 'label' => FieldsParam::FIELD_LABEL_DEMANDE_PROJECT . '<img src="/svg/information.svg" width="12px" height="12px" class="has-tooltip ml-1" title="Va chercher dans le référentiel projet">', 'displayedCreate' => false, 'displayedEdit' => false, 'displayedFilters' => false],
            ],
