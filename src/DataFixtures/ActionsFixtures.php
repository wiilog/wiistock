    ...
    public const MENUS = [
        ...
        Menu::NOMADE => [
            ...
            self::SUB_MENU_TRACING => [
                ...
                Action::MODULE_ACCESS_READING_MENU,
                Action::MODULE_ACCESS_PICK_AND_DROP,
            ],
            self::SUB_MENU_STOCK => [
