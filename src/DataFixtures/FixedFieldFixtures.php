    ...
    public function load(ObjectManager $manager): void {
        ...
        $listEntityFieldCodes = [
            ...
            FixedFieldStandard::ENTITY_CODE_PRODUCTION => [
                ...
                ['code' => FixedFieldEnum::destinationLocation->name, 'label' => FixedFieldEnum::destinationLocation->value, 'displayedCreate' => true, 'displayedEdit' => true, 'displayedFilters' => false],
            ],
        ];
