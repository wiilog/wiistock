...
class SelectController extends AbstractController {
        ...
        if ($redirectRoute) {
            $results
                ->unshift([
                    ...
                    "html" => "<div class='create-new-container'><span class='wii-icon wii-icon-plus'></span> <b>Nouvelle Référence</b></div>",
                ]);
        }
    ...
    public function keyboardPack(Request                $request,
        ...
        return new StreamedJsonResponse([
            "results" => $packService->getFormatedKeyboardPackGenerator($results, $completeMatch ?? false) ?? [],
            "error" => $error ?? null,
        ]);
    ...
    public function customers(Request $request, EntityManagerInterface $entityManager): Response {
        ...
        array_unshift($customers, [
            "id" => "create-new",
            "html" => "<div class='create-new-container'><span class='wii-icon wii-icon-plus'></span> <b>Nouveau client</b></div>",
        ]);
    ...
    public function truckArrivalLineNumber(Request $request, EntityManagerInterface $manager): Response {
        ...
        $canCreateNew = $request->query->get("create-new");
        ...
        if($canCreateNew && $term){
            array_unshift($lines, [
                "id" => "create-new",
                "html" => "<div class='create-new-container'><span class='wii-icon wii-icon-plus'></span> <b>Nouveau numéro tracking</b></div>",
            ]);
        }
