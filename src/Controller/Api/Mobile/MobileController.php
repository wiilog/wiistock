        ...
        if ($line) {
            ...
            if ($ref) {
                ...
                $data = [
                    ...
                    'natureId' => $ref->getDispatchPack()->getPack()->getNature()?->getId() ?? null,
                    'packWeight' => $ref->getDispatchPack()->getPack()->getWeight() ?? null,
                    'packVolume' => $ref->getDispatchPack()->getPack()->getVolume() ?? null,
                    'packComment' => $ref->getDispatchPack()->getPack()->getComment() ?? null,
