...
class ApiController extends AbstractFOSRestController implements ClassResourceInterface {
    ...
    public function beginPrepa(Request $request,
        ...
        return $this->json($this->successDataMsg);
    }
...
//TODO  CG msg prépa vide
     ...
     * @throws NonUniqueResultException
     */
    public function beginLivraison(Request $request, EntityManagerInterface $em) {
        $nomadUser = $this->getUser();

        $livraisonRepository = $em->getRepository(Livraison::class);
     ...
     */
    public
    function beginCollecte(Request $request,
                           EntityManagerInterface $entityManager) {
        $nomadUser = $this->getUser();
