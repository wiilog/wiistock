...
describe('Edit and save components in Referentiel > Transporteurs', () => {
    ...
    it('should add a new transporter', () => {
        ...
        cy.get(`button[type='submit']`).click().wait('@transporteur_save');
...
describe('Edit and save components in Referentiel > Nature', () => {
    ...
    it('should add a new nature', () => {
        ...
        cy.get('#modalNewNature').should('be.visible');
        ...
        cy.get(`button#submitNewNature`).click().wait('@nature_new');
...
describe('Edit and save components in Referentiel > Véhicules', () => {
    ...
    it('should add a new vehicle', () => {
        ...
        cy.get('#modalNewVehicle').should('be.visible');
        cy.get('#modalNewVehicle input[name=registrationNumber]').type('CL-010-RA');
        cy.get(`.modal-footer button`).eq(1).click().wait('@vehicule_new');
    ...
    it ('should edit a vehicle', () => {
        ...
        cy.wait('@vehicule_api');
        cy.get('#vehicleTable_id tbody td').contains('VEHICULE').then((td) => {
            cy.wrap(td).parent('tr').find('td').eq(1).contains('VEHICULE');
        });
    })
})
...
describe('Edit and save components in Referentiel > Projet', () => {
    ...
    it('should add a new project', () => {
        ...
        cy.get('#modalNewProject').should('be.visible');
        cy.get('#modalNewProject input[name=code]').type('GAZ');
        cy.select2Ajax('projectManager', 'Admin');
        cy.get(`#modalNewProject button[type=submit]`).click().wait('@project_new');
...
describe('Edit and save components in Referentiel > Clients', () => {
    ...
    it('should add a new customer', () => {
        ...
        cy.get(`button[data-toggle='modal']`).click();
        cy.get('#modalNewCustomer').should('be.visible');
        cy.get('#modalNewCustomer input[name=name]').type('LAPEL');
        ...
        cy.get(`#modalNewCustomer button[type=submit]`).click().wait('@customer_new');
