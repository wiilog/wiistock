...
class DateTimeServiceTest extends KernelTestCase
{
    ...
    private const localPathCacheDay = 'work-period';

    private const fileNameWorkedDay = 'workedDay';

    private const fileNameFreeDay = 'workFreeDay';

    public const arrayWorkedPeriod = [
    ...
    public const arrayWorkedPeriodBroken = [
    ...
    private const arrayWorkedPeriodEmpty = [];
    ...
    private function testGetWorkedPeriod(array $arrayWordedDay, array $arrayFreeDay, string $dateString1, string $dateString2, string $expected): void
    {
        ...
        $this->assertEquals(
            $this->dateTimeService->convertDateIntervalToMilliseconds(new DateInterval($expected)),
    ...
    private function testAddWorkedPeriod(array $arrayWordedDay, array $arrayFreeDay, $dateString, $dateStringInterval, ?string $expected): void
    {
        ...
        $this->assertEquals(
            $expected,
            $this->dateTimeService->addWorkedPeriodToDateTime($this->entityManager, $date, $dateInterval)?->format("Y-m-d H:i:s")
        );
    }

    private function createCacheWorkedPeriod(array $arrayWordedDay, array $arrayFreeDay): void
    {
        $this->cacheService->set($this::localPathCacheDay, $this::fileNameWorkedDay, $arrayWordedDay);
        $this->cacheService->set($this::localPathCacheDay, $this::fileNameFreeDay, $arrayFreeDay);
    }
    ...
    * */
    public function testGetWorkedPeriodBetweenDatesWithBreak(): void
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 08:00:00', '2024-10-08 17:00:00',
            "PT8H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-11 08:00:00', '2024-10-11 19:00:00',
            "PT9H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-07 08:00:00', '2024-10-07 18:00:00',
            "PT10H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 17:00:00', '2024-10-08 08:00:00',
            "PT8H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 08:00:00', '2024-10-08 08:00:00',
            "PT0H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-10 08:00:00', '2024-10-10 17:00:00',
            "PT0H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriod(), '2024-10-08 08:00:00', '2024-10-08 17:00:00',
            "PT0H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-10 08:00:00', '2024-10-11 10:00:00',
            "PT2H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriod(), '2024-10-08 08:00:00', '2024-10-09 10:00:00',
            "PT2H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriodEmpty, $this->arrayFreePeriodEmpty(), '2024-10-08 08:00:00', '2024-10-08 17:00:00',
            "PT0H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 18:00:00', '2024-10-09 08:00:00',
            "PT0H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 21:00:00', '2024-10-08 23:00:00',
            "PT0H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 21:00:00', '2024-10-09 23:00:00',
            "PT8H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 07:00:00', '2024-10-16 23:00:00',
            "PT51H"
        );
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriod(), '2024-10-08 07:00:00', '2024-10-16 23:00:00',
            "PT43H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 13:00:00', '2024-10-09 10:00:00',
            "PT6H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 10:00:00', '2024-10-08 14:00:00',
            "PT3H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-07 10:00:00', '2024-10-07 14:00:00',
            "PT4H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriodBroken, $this->arrayFreePeriodEmpty(), '2024-10-07 08:00:00', '2024-10-07 18:00:00',
            "PT4H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 10:30:00', '2024-10-09 11:30:00',
            "PT9H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 10:00:00', '2024-10-16 14:00:00',
            "PT46H"
        );
    }
    ...
    {
        $this->testGetWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 08:21:00', '2024-10-09 15:37:00',
            "PT14H16M"
        );
    }
    ...
    public function testAddWorkedIntervalToDateTimeWithBreak(): void
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 08:00:00', 'PT5H',
            "2024-10-08 14:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-11 08:00:00', 'PT8H',
            "2024-10-11 18:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-07 08:00:00', 'PT5H',
            "2024-10-07 13:00:00"
        );
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 08:00:00', 'PT9H',
            "2024-10-09 09:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-09 08:00:00', 'PT9H',
            "2024-10-11 09:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriod(), '2024-10-07 08:00:00', 'PT11H',
            "2024-10-09 09:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriod(), '2024-10-08 08:00:00', 'PT0H',
            "2024-10-08 08:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 08:00:00', 'PT0H',
            "2024-10-08 08:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriodEmpty, $this->arrayFreePeriodEmpty(), '2024-10-08 08:00:00', 'PT5H',
            null
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-09 18:00:00', 'PT11H',
            "2024-10-14 10:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriod(), '2024-10-07 18:00:00', 'PT10H',
            "2024-10-11 10:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 19:00:00', 'PT2H',
            "2024-10-09 10:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 07:00:00', 'PT51H',
            "2024-10-16 17:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriod(), '2024-10-08 07:00:00', 'PT43H',
            "2024-10-16 17:00:00"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 08:00:00', 'PT2S',
            "2024-10-08 08:00:02"
        );
    }
    ...
    {
        $this->testAddWorkedPeriod(
            $this::arrayWorkedPeriod, $this->arrayFreePeriodEmpty(), '2024-10-08 08:21:00', 'PT14H16M',
            "2024-10-09 15:37:00"
        );
    }
